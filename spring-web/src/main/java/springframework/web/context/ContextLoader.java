...
package springframework.web.context;
...
public class ContextLoader {
    ...
    protected WebApplicationContext createWebApplicationContext(ServletContext sc) {
        // 决定到底用哪个 WebApplicationContext 的类，首先从 web.xml 中 <context-param> 的 <param-name> 中找 contextClass，看是否有指定某个 class，如果有指定，则载入对应的 class
        // 如果没有指定，就默认用 XmlWebApplicationContext
