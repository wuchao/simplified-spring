...
public abstract class WebApplicationContextUtils {
    ...
    public static void registerEnvironmentBeans(ConfigurableListableBeanFactory bf,
        ...
        if (!bf.containsBean(WebApplicationContext.CONTEXT_PARAMETERS_BEAN_NAME)) {
            ...
            // 注册 servletContext 对象里的 initParameter
            if (servletContext != null) {
                /**
                 * Enumeration 接口中定义了一些方法，通过这些方法可以枚举（一次获得一个）对象集合中的元素。
                 * 这种传统接口已被迭代器取代。
                 *
                 * 获取 servlet context 所有配置的初始参数名称
                 * 然后循环名称，去取值保存到 map 对象中
                 */
            ...
            // 注册 servletConfig 对象里的 initParameter
    ...
    /**
     * 替换掉 servletConfigInitParam 和 servletContextInitParam
